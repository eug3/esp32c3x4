/**
 * @file font_loader.h
 * @brief XTEink 字体加载器 - 只支持 XTEinkFontBinary 格式
 */
...
typedef struct {
    ...
    xt_eink_font_t *xt_font;          // XTEink 字体上下文
